...
namespace Aquarius.UnitTests.TimeSeries.Client.Helpers
{
    ...
    public class DurationExtesionsTests
    {
        ...
        private static readonly IEnumerable<TestCaseData> ValidDurationStringPairs = new[]
        {
            ...
            new TestCaseData("P1D", Duration.FromDays(1)),
            new TestCaseData("-P1D", Duration.FromDays(-1)),
            new TestCaseData("P366D", Duration.FromDays(366)),
            ...
            new TestCaseData("-PT1S", Duration.FromSeconds(-1)),
            new TestCaseData("P3DT5H", Duration.FromDays(3) + Duration.FromHours(5)),
            new TestCaseData("P3DT5M", Duration.FromDays(3) + Duration.FromMinutes(5)),
            new TestCaseData("P3DT5S", Duration.FromDays(3) + Duration.FromSeconds(5)),
            new TestCaseData("P2DT3H5M8S", Duration.FromDays(2) + Duration.FromHours(3) + Duration.FromMinutes(5) + Duration.FromSeconds(8)),
            new TestCaseData("-P2DT3H5M8S", -(Duration.FromDays(2) + Duration.FromHours(3) + Duration.FromMinutes(5) + Duration.FromSeconds(8))),
